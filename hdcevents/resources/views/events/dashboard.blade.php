  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="/eventos/{{ $event->id }}/editar" class="btn btn-info edit-btn"><ion-icon name="create-outline"></ion-icon>Editar</a>
  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{ count($event->users) }}</td>
        <td>
          <form action="/eventos/{{ $event->id }}/sair" method="POST">
            @csrf
            @method("DELETE")
